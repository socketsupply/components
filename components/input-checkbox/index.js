...
InputCheckbox._xml = `version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"`
InputCheckbox._svg = {}
InputCheckbox._svg.on = props => `
  <svg ${InputCheckbox._xml} x="0px" y="0px" width="${props.width}" height="${props.height}" viewBox="0 0 100 100" xml:space="preserve">
